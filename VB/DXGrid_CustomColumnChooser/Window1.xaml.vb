...
Namespace DXGrid_CustomColumnChooser
	...
	Public Class CustomColumnChooser
		...
		End Sub
		Private Sub ApplyState(ByVal state As IColumnChooserState) _
				Implements IColumnChooser.ApplyState
		End Sub
		Private Sub SaveState(ByVal state As IColumnChooserState) _
				Implements IColumnChooser.SaveState
		End Sub
		Private Sub Destroy() Implements IColumnChooser.Destroy
		End Sub
		Private ReadOnly Property TopContainer() As UIElement _
				Implements IColumnChooser.TopContainer
			Get
		...
		Private Function Create(ByVal view As GridViewBase) As IColumnChooser _
				Implements IColumnChooserFactory.Create
			Return Me
		End Function
		#End Region
	End Class
	Public Class CustomColumnChooserControl
		...
		Shared Sub New()
			DefaultStyleKeyProperty.OverrideMetadata(GetType(CustomColumnChooserControl), _
				New FrameworkPropertyMetadata(GetType(CustomColumnChooserControl)))
			ViewProperty = DependencyProperty.Register("View", GetType(GridViewBase), _
				GetType(CustomColumnChooserControl), New UIPropertyMetadata(Nothing))
		End Sub
		...
		Public Overrides Sub OnApplyTemplate()
			...
			ColunmChooserControl = CType(GetTemplateChild("PART_ColumnChooserControl"), _
